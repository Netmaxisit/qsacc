...
export default function SmallBusinessServicesPage() {
  ...
  return (
    <main>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2
              ...
              style={{ color: "#1A2B2E" }}
            >
              Comprehensive Support for Small Business Success
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2
              ...
              style={{ color: "#0E5D6B" }}
            >
              Additional Services for Your Small Business
            </h2>

            <div className="space-y-6 text-base leading-relaxed" style={{ color: "#475569" }}>
              <div>
                <h3 className="text-xl font-bold mb-3" style={{ color: "#1A2B2E" }}>Payroll Services</h3>
                <p>
                  Managing payroll can be time-consuming and complex. Our payroll services streamline the process,
                  ensuring that your employees are paid accurately and on time while staying compliant with payroll regulations.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold mb-3" style={{ color: "#1A2B2E" }}>Compliance and Regulatory Support</h3>
                <p>
                  Staying compliant with regulatory requirements is crucial for small businesses. Our team helps you navigate
                  complex regulations and ensures that your business remains in good standing with regulatory authorities.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2
              ...
              style={{ color: "#0E5D6B" }}
            >
              Your Trusted Partner for Small Business Success
            </h2>
            <p className="text-base leading-relaxed mb-6" style={{ color: "#475569" }}>
              Partner with Quick Solve Accountants to access a comprehensive range of services tailored to the unique needs
      ...
      {/* CTA */}
      <AppointmentCTA headline="Goodbye guesswork, hello clear records." />
