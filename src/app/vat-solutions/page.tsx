...
export default function VATSolutionsPage() {
  ...
  return (
    <main>
        ...
        <div className="relative z-10 flex-1 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-10 w-full">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Expert VAT Solutions for{" "}
                <span style={{ color: "#D3B267" }}>Compliance & Savings</span>
              </motion.h1>
              ...
              >
                Navigating tax and VAT requirements can be daunting for businesses of all sizes.
                Quick Solve Accountants provides comprehensive VAT services to ensure compliance
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2
              ...
              style={{ color: "#1A2B2E" }}
            >
              Comprehensive VAT Services Tailored to Your Business
            </h2>

            <div className="space-y-6 text-base leading-relaxed" style={{ color: "#475569" }}>
              <p>
                Navigating tax and VAT requirements can be daunting for businesses of all sizes.
                Quick Solve Accountants provides comprehensive services to ensure compliance and maximise savings.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto" style={{ color: "#475569" }}>
              Expert guidance to keep you compliant and optimise your VAT position.
            </p>
          </motion.div>
      ...
      <section className="py-24 lg:py-32" style={{ background: "rgba(14,93,107,0.03)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-6 text-base leading-relaxed" style={{ color: "#475569" }}>
              <div>
                <h3 className="text-xl font-bold mb-3" style={{ color: "#1A2B2E" }}>VAT Advisory Services</h3>
                <p>
                  Navigating complex VAT regulations requires expert guidance. We provide advisory services tailored to your business,
                  helping you understand your VAT obligations, optimise VAT processes, and resolve any VAT-related issues that may arise.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold mb-3" style={{ color: "#1A2B2E" }}>VAT Compliance Reviews</h3>
                <p>
                  Our thorough compliance reviews help identify potential areas of risk or non-compliance with VAT regulations.
                  We conduct comprehensive audits to ensure that your VAT processes are robust and compliant, mitigating any potential liabilities.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2
              ...
              style={{ color: "#0E5D6B" }}
            >
              Expert Tax & VAT Solutions for Your Business
            </h2>
            <p className="text-base leading-relaxed mb-6" style={{ color: "#475569" }}>
              Partner with Quick Solve Accountants for VAT solutions tailored to your business needs.
              Our proactive approach and attention to detail ensure that you remain compliant while
      ...
      {/* CTA */}
      <AppointmentCTA headline="Clarity in every entry." />
